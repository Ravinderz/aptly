  ...
  const fetchSocietyDetails = async () => {
    ...
    try {
      ...
      if (societyCode === 'INVALID') {
        setError(
          'Society code not found. Please check with your society management.',
        );
      } else {
      ...
      <SafeAreaView className="flex-1 bg-background">
        ...
        <View className="flex-1 items-center justify-center px-6">
          ...
          <Text className="text-text-secondary text-center mb-8 leading-6">
            {error ||
              "We couldn't find a society with the provided code. Please check your society code and try again."}
          </Text>
          ...
          <View className="bg-primary/5 rounded-xl p-4 mt-4">
            ...
            <Text className="text-text-secondary text-body-medium leading-5">
              Contact your society management or housing committee to get the
              correct society code.
            </Text>
          </View>
        </View>
      </SafeAreaView>
    ...
    <SafeAreaView className="flex-1 bg-background">
      ...
      <ScrollView
          ...
          <View className="flex-row justify-between mb-4">
            ...
            <View className="items-center">
              <Text className="text-display-small font-bold text-primary">
                {Math.round(
                  (society.registeredResidents / society.totalFlats) * 100,
                )}
                %
              </Text>
              <Text className="text-text-secondary text-body-medium">
        ...
        <View className="bg-success/5 rounded-xl p-4 mb-6 border border-success/20">
          ...
          <Text className="text-text-secondary text-body-medium leading-5">
            Your phone number and society code have been verified. You can now
