...
const mockNotifications: Notification[] = [
  {
    ...
    message:
      'Rajesh Kumar wants to visit you today at 3:30 PM. Please approve or decline this request.',
    category: 'security',
  ...
  },
  {
    ...
    message:
      'Your January maintenance bill of ₹5,420 has been generated. Due date: 31st January.',
    category: 'billing',
  ...
  },
  {
    ...
    message:
      'Water supply will be interrupted tomorrow (16th Jan) from 10 AM to 2 PM for tank cleaning.',
  ...
  },
  {
    ...
    message:
      'Join us for Holi celebration on 25th March at the clubhouse. Registration required.',
    category: 'community',
  ...
  },
  {
    ...
    message:
      'Your gym slot for tomorrow 7-8 AM has been confirmed. Please arrive on time.',
    category: 'community',
                  ...
                  <View className="flex-row items-start p-4">
                    ...
                    <View className="flex-1">
                      <View className="flex-row items-start justify-between mb-1">
                        <Text
                          className={`text-body-large font-semibold flex-1 pr-2 ${
                            !notification.isRead
                              ? 'text-text-primary'
                              : 'text-text-secondary'
                          }`}>
