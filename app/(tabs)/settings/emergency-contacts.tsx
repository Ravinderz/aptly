          ...
          <Card
            ...
            <View className="flex-row items-start">
              ...
              <View
                ...
                style={{
                  backgroundColor: `${getRelationshipColor(contact.relationship)}15`,
                }}>
                <Phone
                  size={24}
                  ...
                  {contact.alternatePhone && (
                    <TouchableOpacity
                      ...
                      <Text className="text-text-secondary text-sm ml-2">
                        +91 {formatIndianPhoneNumber(contact.alternatePhone)}{' '}
                        (Alternate)
                      </Text>
                    </TouchableOpacity>
                  )}
        ...
        {contacts.length === 0 && (
          <View className="items-center justify-center py-12">
            ...
            <Text className="text-text-secondary text-center mb-6 px-4">
              Add emergency contacts who can be reached in case of urgent
              situations.
            </Text>
            <Button onPress={handleAddContact}>Add Emergency Contact</Button>
          </View>
        )}
