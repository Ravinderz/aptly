...
import { ScrollView, SafeAreaView, View, Text, TouchableOpacity, RefreshControl } from 'react-native';
import { ArrowLeft, Bell, Calendar, Filter, Search } from 'lucide-react-native';
      ...
      const mockNotices: Notice[] = [
        {
          ...
          description: 'Water supply will be interrupted tomorrow (Jan 20) from 10 AM to 2 PM for tank cleaning. Please store water in advance. The maintenance team will be cleaning the overhead tank and checking all pump connections.',
          variant: 'warning',
          date: '2024-01-19',
        ...
        },
        {
          ...
          description: 'Monthly society meeting scheduled for Saturday 6 PM in the community hall. Agenda includes budget discussion, new security rules, festival celebration plans, and maintenance schedule updates.',
          variant: 'info',
          date: '2024-01-18',
          category: 'community',
          priority: 'medium',
        ...
        },
        {
          ...
          description: 'All visitors must now register via the app. Identity verification is mandatory for entry after 8 PM. Security guards will strictly follow the new protocol.',
          variant: 'primary',
          date: '2024-01-17',
          category: 'security',
          priority: 'high',
        ...
        },
        {
          ...
          description: 'Join us for Holi celebrations on March 25th at the community garden. Colors, sweets, and music will be arranged. Contact organizing committee for volunteer opportunities.',
          variant: 'success',
          date: '2024-01-16',
          category: 'community',
          priority: 'low',
        ...
        },
        {
          ...
          description: 'Lift #2 will be under maintenance from Jan 22-24. Please use Lift #1 or stairs during this period. Sorry for the inconvenience.',
          variant: 'warning',
          date: '2024-01-15',
          category: 'maintenance',
          priority: 'medium',
        ...
        },
        {
          ...
          description: 'Updated parking guidelines effective from Feb 1st. Two-wheelers should be parked in designated areas only. Violation fine: ₹200.',
          variant: 'info',
          date: '2024-01-14',
          category: 'general',
          priority: 'medium',
        ...
        {loading ? (
          ...
          filteredNotices.map((notice) => (
            <TouchableOpacity
              ...
              className="mb-4"
            >
              <Card className={`${!notice.isRead ? 'border-primary border-2' : ''}`}>
                {/* Unread indicator */}
                {!notice.isRead && (
                  ...
                  <View className="flex-row items-start justify-between mb-2">
                    <View className="flex-1 mr-4">
                      <Text className={`text-body-large font-semibold ${
                        !notice.isRead ? 'text-text-primary' : 'text-text-secondary'
                      }`}>
                        {notice.title}
                      </Text>
