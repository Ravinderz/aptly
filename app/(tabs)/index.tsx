...
export default function HomeScreen() {
  ...
  return (
    <Header>
      ...
      <QuickActions /> */}
      <View className="my-6">
        <TouchableOpacity className="flex flex-row gap-4 justify-center items-center bg-[#fed0b5] h-20 rounded-xl p-4 border-2 border-[#d59f7e]">
            ...
            <BottomSheetView style={styles.contentContainer}>
              <View className="w-full px-4">
                ...
                <View className="flex flex-row justify-around my-6">
                  ...
                  <TouchableOpacity className="flex flex-row gap-2 justify-center items-center bg-light h-16 w-36 rounded-lg">
