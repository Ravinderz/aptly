...
export default function PaymentSuccess() {
  ...
  const getSuccessMessage = (service: string) => {
    switch (service) {
      case 'mobile-recharge':
        return 'Your mobile has been recharged successfully!';
      case 'broadband-recharge':
        return 'Your broadband has been recharged successfully!';
      case 'cylinder-booking':
        return 'Your gas cylinder has been booked successfully!';
      case 'gas-recharge':
        return 'Your PNG account has been recharged successfully!';
      case 'dishtv-recharge':
        return 'Your DTH has been recharged successfully!';
      default:
