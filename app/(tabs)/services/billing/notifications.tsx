...
export default function BillingNotifications() {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      message:
        'Your maintenance bill for March 2024 is overdue. Please pay ₹6,195 to avoid late fees.',
      amount: 6195,
      billId: '1',
    ...
    },
    {
      ...
      message:
        'Water bill payment of ₹885 is due tomorrow. Pay now to avoid late charges.',
      amount: 885,
      billId: '2',
    ...
    },
    {
      ...
      message:
        'Common Area Maintenance bill for ₹3,304 has been generated. Due date: April 15, 2024.',
      amount: 3304,
      billId: '5',
    ...
    },
    {
      ...
      message:
        'Your payment of ₹802 for February water bill has been processed successfully.',
      amount: 802,
      billId: '4',
    ...
    },
    {
      ...
      message:
        'Auto payment of ₹6,195 for maintenance bill is scheduled for tomorrow.',
      amount: 6195,
      billId: '1',
  ...
  const getNotificationIcon = (type: string, urgent: boolean) => {
    ...
    switch (type) {
      case 'overdue':
        return <AlertCircle size={size} color="#D32F2F" />;
      case 'payment_reminder':
        return <Calendar size={size} color="#FF9800" />;
      case 'bill_generated':
      ...
      <View className="flex-row items-center px-4 py-4 border-b border-divider bg-surface">
        ...
        {activeTab === 'notifications' && notifications.length > 0 && (
          <TouchableOpacity onPress={handleMarkAllAsRead} className="mr-2">
            <Text className="text-primary font-medium text-body-medium">
              Mark All Read
            </Text>
          </TouchableOpacity>
        )}
      ...
      <View className="flex-row bg-surface border-b border-divider">
        {[
          ...
          <TouchableOpacity
            key={tab.key}
            onPress={() =>
              setActiveTab(tab.key as 'notifications' | 'settings')
            }
          ...
          {notifications.length === 0 ? (
            <View className="flex-1 items-center justify-center py-16">
              ...
              <Text className="text-text-secondary text-center">
                You&apos;re all caught up! Billing notifications will appear
                here.
              </Text>
            </View>
          ) : (
              ...
              <View className="space-y-4">
                {[
                  ...
                  },
                  {
                    key: 'billGenerated',
                    label: 'New Bills',
                    description: 'Notification when new bills are generated',
                  },
                  {
                    key: 'paymentSuccess',
                  ...
                  },
                  {
                    ...
                    description: 'Important alerts for overdue payments',
                  },
                  {
                    key: 'autoPayNotifications',
                    label: 'Auto Pay Updates',
                    description: 'Status updates for automatic payments',
                  },
                ].map((setting) => (
                  <View
                    key={setting.key}
              ...
              <View className="space-y-4">
                <View className="flex-row items-center justify-between">
                  <View className="flex-1 mr-4">
                    ...
                    <Text className="text-text-secondary text-body-medium">
                      Always enabled for critical notifications
                    </Text>
                  </View>
              ...
              <View className="space-y-4">
                <View>
                  ...
                  <Text className="text-text-secondary text-body-medium mb-3">
                    Get payment reminders {settings.reminderDays} days before
                    the due date
                  </Text>
