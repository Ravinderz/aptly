...
export default function Billing() {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      case "paid": return <LucideIcons name="checkmark-circle" size={16} color="#4CAF50" />;
      case "pending": return <LucideIcons name="calendar-outline" size={16} color="#FF9800" />;
      case "overdue": return <LucideIcons name="alert-circle" size={16} color="#D32F2F" />;
      default: return <LucideIcons name="calendar-outline" size={16} color="#757575" />;
    }
  };
    ...
    <SafeAreaView className="flex-1 bg-background">
      ...
      >
        ...
        <View className="flex-row items-center px-6 py-4 border-b border-divider bg-surface">
          ...
          >
            <LucideIcons name="notifications-outline" size={20} color="#6366f1" />
