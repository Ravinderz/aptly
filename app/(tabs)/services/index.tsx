...
import { Wrench, Receipt, Plus, Clock, TrendingUp, Users, Phone } from "lucide-react-native";
      ...
      >
        <View className="px-6 pt-6">
          ...
          <View className="mb-8">
            ...
            <Text className="text-text-secondary">Maintenance requests, verified vendors, and billing</Text>
          </View>
          ...
          {/* Main Services Grid */}
          <View className="mb-8">
            <Text className="text-lg font-semibold text-text-primary mb-4">Services</Text>
            ...
            >
              <View className="flex-row items-center">
                ...
                <View className="flex-1">
                  <Text className="text-lg font-semibold text-text-primary mb-1">Vendor Directory</Text>
                  <Text className="text-text-secondary text-sm mb-3">Find trusted service providers for your home</Text>
                  <View className="flex-row items-center gap-2">
                    <View className="bg-secondary/20 rounded-full px-3 py-1">
                      <Text className="text-secondary text-xs font-medium">72 Vendors</Text>
                    </View>
                    <View className="bg-warning/20 rounded-full px-3 py-1">
                      <Text className="text-warning text-xs font-medium">★ 4.3 Avg Rating</Text>
                    </View>
                  </View>
                </View>
            ...
            <View className="flex-row gap-4">
              ...
              >
                ...
                <Text className="text-text-secondary text-sm mb-4">Submit and track repair requests</Text>
                <View className="flex-row items-center">
                  <View className="bg-warning/20 rounded-full px-3 py-1">
              ...
              >
                ...
                <Text className="text-text-secondary text-sm mb-4">View bills and payment history</Text>
                <View className="flex-row items-center">
                ...
                {recentRequests.map((request) => (
                  ...
                  >
                    <View className="flex-row items-start justify-between mb-3">
                      ...
                      <View className={`rounded-full px-3 py-1 ${getPriorityColor(request.priority)}`}>
                    ...
                    <View className="flex-row items-center justify-between">
                      <View className="flex-row items-center">
                        ...
                        <Text className="text-text-secondary text-sm ml-2">{request.date}</Text>
                      </View>
            ...
            <View className="mb-8">
              ...
              <View className="space-y-3">
                {unpaidBills.map((bill) => (
                  ...
                  >
                    <View className="flex-row items-start justify-between mb-3">
                      <Text className="text-text-primary font-medium flex-1 mr-3">{bill.title}</Text>
          ...
          {/* Analytics Overview */}
          <View className="mb-8">
            <Text className="text-lg font-semibold text-text-primary mb-4">This Month</Text>
            <View className="bg-surface rounded-2xl p-6 border border-divider">
              <View className="flex-row items-center mb-5">
                <TrendingUp size={20} color="#4CAF50" />
                <Text className="text-text-primary font-medium ml-3">Activity Summary</Text>
              </View>
              <View className="flex-row justify-between">
                <View className="items-center">
                  <Text className="text-2xl font-bold text-text-primary mb-1">3</Text>
                ...
                <View className="items-center">
                  <Text className="text-2xl font-bold text-text-primary mb-1">₹12,450</Text>
