...
const serviceCategories = [
  {
    ...
    icon: <Wrench size={32} color="#6366f1" />,
    vendorCount: 12,
    avgRating: 4.3,
  },
  {
  ...
  },
  {
    ...
    icon: <Home size={32} color="#6366f1" />,
    vendorCount: 15,
    avgRating: 4.2,
  },
  {
    ...
    icon: <Snowflake size={32} color="#6366f1" />,
    vendorCount: 6,
    avgRating: 4.4,
  },
  {
    ...
    icon: <Truck size={32} color="#6366f1" />,
    vendorCount: 20,
    avgRating: 4.1,
  },
  {
  ...
  },
  {
    ...
    icon: <TreePine size={32} color="#6366f1" />,
    vendorCount: 7,
    avgRating: 4.3,
  },
  {
