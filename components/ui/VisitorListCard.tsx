  ...
  return (
    <View className="bg-white border border-border-color rounded-lg p-4 elevation-sm flex-1">
      <View className="flex flex-row justify-between items-center">
        <Text className="text-md font-medium">Delivery - Amazon</Text>
      ...
      <View className="flex flex-row gap-2 items-center mt-1">
        ...
        <Text className="text-sm text-gray-500">Today, 2: 30 PM</Text>
      </View>
      <View className="flex flex-row gap-2 items-center justify-between mt-3">
        ...
        <View className="flex-1">
          <TouchableOpacity className="py-3 rounded-lg border border-border-color w-full flex-1">
