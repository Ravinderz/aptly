  ...
  return (
    <View className={cn(
      ...
      <View className="flex flex-row justify-between items-center">
        <Text className="text-headline-medium font-semibold text-text-primary">Delivery - Amazon</Text>
        <Text className="text-label-large text-center text-primary px-3 py-1 bg-primary/10 rounded-full">
          Expected
        </Text>
      </View>
      <View className="flex flex-row gap-2 items-center mt-1">
        <Clock size={14} color="#757575" strokeWidth={2} />
        <Text className="text-body-medium text-text-secondary">Today, 2: 30 PM</Text>
      </View>
